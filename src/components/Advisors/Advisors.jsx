  ...
  return (
    <div>
      ...
      <div className="flex justify-center gap-16 w-4/5 mx-auto flex-wrap pt-32 relative ">
        <div className="flex flex-col items-center border-2 border-white w-[300px] rounded-3xl gap-12 mb-28 relative">
          ...
          <div className="flex flex-col gap-6 items-center pb-10">
            <div className="flex flex-col items-center gap-2">
              <p className="text-3xl text-center font-semibold">Tomas</p>
              <p className="text-lg text-center font-semibold">CEO</p>
            </div>
            <div className="flex gap-3 dotted-spaced2 pt-8">
              <p className="text-2xl text-[#0a9996] border-r-2 border-white pr-3">
                Linkedin
              </p>
              <p className="text-2xl text-[#0a9996]">Read bio</p>
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center border-2 border-white w-[300px] rounded-3xl gap-12 mb-28 relative">
